...
Verification: `node test/remote-diagnostics.mjs` checks browser opt-in/out, payload exclusion, receiver validation, and real SharedWorker/model transport with a synthetic MessagePort provider. No family data is sent to a live model by this test.
