...
import { Avatar, Empty, ErrorNotice, Icon, Media, navigate, when } from "./ui";
import { PostEditor } from "./post-editor";
import { PostDetail } from "./post-detail";
import { FamilyChat } from "./chat";
import { Schedule } from "./schedule";
import "./styles.css";
import { GenerationBar, GenerationStatus } from "./generation-ui";
const EMAIL_KEY = "kin:sign-in-email";
const FamilyApps = React.lazy(() =>
  import("./family-apps").then((module) => ({ default: module.FamilyApps })),
);
