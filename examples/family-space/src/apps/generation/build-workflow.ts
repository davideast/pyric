...
import { chorePolicy, policyFixtures, validatePolicy } from "../policies/app-policy";
import { prepareAuthoredPolicy } from "../policies/authored-policy";
import {
  createGenerationPolicyTools,
  policyCapabilities,
} from "../policies/generation-policy-tools";
import { catalog, readUi, checkUiPlan } from "../ui-kit/ui-kit";
import { extractAppSource } from "../runtime/app-context";
import {
