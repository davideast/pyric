import type { UiKit } from "../ui-kit/ui-kit";
...
export type GenerationSpec = {
  ...
  policyWorkflow?: 1;
  requiredPolicy?: import("../policies/app-policy").Policy | null;
  policySelection?: import("../policies/generation-policy-tools").PolicySelection;
  baseSource?: string;
  buildId?: string;
