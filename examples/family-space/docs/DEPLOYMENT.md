...
- **AI generation:** `src/apps/generation/generation-ai-transport.ts` depends on the local Pyric bridge. Static Hosting alone cannot provide it. A production AI Logic transport or authenticated generation backend remains necessary.
