...
6. Reset/import with active apps — in progress. Reset now rebinds retained Firestore listeners in hosted and default SharedWorker mode; import with active Firestore apps and remaining stale-work probes are still open.
