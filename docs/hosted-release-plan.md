...
| 3 Host | spec written 2026-09-19: `docs/hosted-extraction-spec-host.md`; boundary proven on `main` `bbf30034` (82 files; every suite green with the live files present). Prerequisites: D3 live removal closed at `14039436` (live parked at `origin/live/parked` = `2751e1d7`); D1 engine revert merged (row 3a); remaining: C9, C10, D2, D4, H1, I12, I13 rest, and the support contract statement closed | | | |
| 4 Acceptance | | | | |
| 5 Studio and peel | | | | |
