...
The Node host moves Storage bytes over its HTTP byte route and refuses them as
bridge frames. Objects are capped at 512 MiB (`MAX_STORAGE_OBJECT_BYTES`, ADR 0018).
