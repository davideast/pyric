...
- Severity: should-fix. Slice: runtime chip, not hosted. Status: open, mechanism found; the remedy is a design choice for the owner. Reported by the owner on 2026-09-23: Overview shows no highlights; switching to Flow and triggering an update makes Overview work; after a page refresh the Flow update is needed again.
