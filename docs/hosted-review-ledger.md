...
- Severity: should-fix, blocks the foundation slice. Slice: `core`. Status: closed at `1138983b`. Reviewer ran `verify-ledger A14` and an independent compiler probe: both clean; suites and typecheck reproduced. Found by the extraction proof on 2026-09-19.
