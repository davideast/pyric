...
You have a backend. [How the swap works](./what-just-happened.md) explains the swap in one page, or go straight to [signing users in](../build/sign-in-and-manage-users.md).
