...
In Pyric today, maturity belongs in the decision too. Firestore is v1, tested against recorded production behavior. Realtime Database is [experimental](../trust/whats-experimental.md): it works, but most of its behavior is not yet pinned to a production observation. If either service would fit, pick Firestore.
