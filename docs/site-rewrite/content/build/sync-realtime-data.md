...
Not sure the tree is the right home for this data? [Which data service should I use?](./which-data-service.md) is the one-page answer. When the paths are settled, [secure it with rules](../secure/secure-it-with-rules.md).
