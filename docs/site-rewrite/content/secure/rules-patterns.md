...
These techniques run up against real budgets, and the exact numbers are in [the limits that actually bite](../secure/limits-that-bite.md). To see how far the techniques reach, the finished proof is in [what's possible](../secure/whats-possible.md).
