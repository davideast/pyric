...
Start with [the quickstart](./get-started/start-building.md). If you came for rules, go straight to [prove a user can touch only their own data](./secure/secure-it-with-rules.md).
