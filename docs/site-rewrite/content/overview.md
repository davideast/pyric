...
The agent can seed data, run queries, and simulate a rules verdict before it writes, all in the same event stream you watch. Nothing leaves your machine. One page sets it up: [set up your agent](./agent/set-up-your-agent.md).
