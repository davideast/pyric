...
export function captureScope(value) {
    ...
    if (value.documentCollection !== undefined) {
        if (!['allowanceExperiments', 'capacityExperiments', 'providerContractExperiments', 'integratedAdmissionExperiments', 'automaticRecoveryExperiments', 'fairAllocationExperiments'].includes(value.documentCollection)) throw new Error('Invalid capture document collection');
