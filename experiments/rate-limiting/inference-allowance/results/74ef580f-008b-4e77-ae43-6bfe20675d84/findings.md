...
| lifecycle-confirmed-pending | all scheduled requests observed | 2 | 2 | true |
| lifecycle-confirmed-pending | HTTP status matches outcome | [] | [] | true |
| lifecycle-confirmed-pending | no client transport errors | 0 | 0 | true |
| lifecycle-confirmed-pending | all work settles | 2 | 2 | true |
| lifecycle-confirmed-pending | lifecycle responses | {"replies":{"held":"provider_cancelled","recovered":"completed"},"disconnected":[]} | {"replies":{"held":"provider_cancelled","recovered":"completed"},"disconnected":[]} | true |
| lifecycle-confirmed-pending | one dispatch per request | 2 | 2 | true |
| lifecycle-confirmed-pending | capacity retained until termination | true | true | true |
| lifecycle-confirmed-pending | execution capacity respected | true | true | true |
| lifecycle-confirmed-pending | remote work respects capacity | true | true | true |
| lifecycle-confirmed-pending | unknown outcomes retain capacity | {"unknown":[],"quarantined":[],"finalReserved":0} | {"unknown":[],"quarantined":[],"finalReserved":0} | true |
| lifecycle-confirmed-pending | cancellation evidence | {"requested":0,"confirmed":1} | {"requested":0,"confirmed":1} | true |
| lifecycle-confirmed-pending | pre-dispatch stops | 0 | 0 | true |
| lifecycle-confirmed-pending | stream evidence | {"chunks":[],"firstChunkObserved":true} | {"chunks":[],"firstChunkObserved":true} | true |
| lifecycle-confirmed-pending | busy requests avoid database | 0 | 0 | true |
| lifecycle-confirmed-pending | saved debits are not refunded | true | true | true |
| lifecycle-confirmed-pending | complete lifecycle evidence | true | true | true |
| lifecycle-confirmed-resolved | all scheduled requests observed | 2 | 2 | true |
| lifecycle-confirmed-resolved | HTTP status matches outcome | [] | [] | true |
| lifecycle-confirmed-resolved | no client transport errors | 0 | 0 | true |
| lifecycle-confirmed-resolved | all work settles | 2 | 2 | true |
| lifecycle-confirmed-resolved | lifecycle responses | {"replies":{"held":"provider_cancelled","recovered":"completed"},"disconnected":[]} | {"replies":{"held":"provider_cancelled","recovered":"completed"},"disconnected":[]} | true |
| lifecycle-confirmed-resolved | one dispatch per request | 2 | 2 | true |
| lifecycle-confirmed-resolved | capacity retained until termination | true | true | true |
| lifecycle-confirmed-resolved | execution capacity respected | true | true | true |
| lifecycle-confirmed-resolved | remote work respects capacity | true | true | true |
| lifecycle-confirmed-resolved | unknown outcomes retain capacity | {"unknown":[],"quarantined":[],"finalReserved":0} | {"unknown":[],"quarantined":[],"finalReserved":0} | true |
| lifecycle-confirmed-resolved | cancellation evidence | {"requested":0,"confirmed":1} | {"requested":0,"confirmed":1} | true |
| lifecycle-confirmed-resolved | pre-dispatch stops | 0 | 0 | true |
| lifecycle-confirmed-resolved | stream evidence | {"chunks":[],"firstChunkObserved":true} | {"chunks":[],"firstChunkObserved":true} | true |
| lifecycle-confirmed-resolved | busy requests avoid database | 0 | 0 | true |
| lifecycle-confirmed-resolved | saved debits are not refunded | true | true | true |
| lifecycle-confirmed-resolved | complete lifecycle evidence | true | true | true |
| lifecycle-completed-pending | all scheduled requests observed | 2 | 2 | true |
| lifecycle-completed-pending | HTTP status matches outcome | [] | [] | true |
| lifecycle-completed-pending | no client transport errors | 0 | 0 | true |
| lifecycle-completed-pending | all work settles | 2 | 2 | true |
| lifecycle-completed-pending | lifecycle responses | {"replies":{"recovered":"completed","held":"inference_timeout"},"disconnected":[]} | {"replies":{"held":"inference_timeout","recovered":"completed"},"disconnected":[]} | true |
| lifecycle-completed-pending | one dispatch per request | 2 | 2 | true |
| lifecycle-completed-pending | capacity retained until termination | true | true | true |
| lifecycle-completed-pending | execution capacity respected | true | true | true |
| lifecycle-completed-pending | remote work respects capacity | true | true | true |
| lifecycle-completed-pending | unknown outcomes retain capacity | {"unknown":[],"quarantined":[],"finalReserved":0} | {"unknown":[],"quarantined":[],"finalReserved":0} | true |
| lifecycle-completed-pending | cancellation evidence | {"requested":0,"confirmed":0} | {"requested":0,"confirmed":0} | true |
| lifecycle-completed-pending | pre-dispatch stops | 0 | 0 | true |
| lifecycle-completed-pending | stream evidence | {"chunks":[],"firstChunkObserved":true} | {"chunks":[],"firstChunkObserved":true} | true |
| lifecycle-completed-pending | busy requests avoid database | 0 | 0 | true |
| lifecycle-completed-pending | saved debits are not refunded | true | true | true |
| lifecycle-completed-pending | complete lifecycle evidence | true | true | true |
| lifecycle-confirmed-rejected | all scheduled requests observed | 2 | 2 | true |
| lifecycle-confirmed-rejected | HTTP status matches outcome | [] | [] | true |
| lifecycle-confirmed-rejected | no client transport errors | 0 | 0 | true |
| lifecycle-confirmed-rejected | all work settles | 2 | 2 | true |
| lifecycle-confirmed-rejected | lifecycle responses | {"replies":{"held":"provider_cancelled","recovered":"completed"},"disconnected":[]} | {"replies":{"held":"provider_cancelled","recovered":"completed"},"disconnected":[]} | true |
| lifecycle-confirmed-rejected | one dispatch per request | 2 | 2 | true |
| lifecycle-confirmed-rejected | capacity retained until termination | true | true | true |
| lifecycle-confirmed-rejected | execution capacity respected | true | true | true |
| lifecycle-confirmed-rejected | remote work respects capacity | true | true | true |
| lifecycle-confirmed-rejected | unknown outcomes retain capacity | {"unknown":[],"quarantined":[],"finalReserved":0} | {"unknown":[],"quarantined":[],"finalReserved":0} | true |
| lifecycle-confirmed-rejected | cancellation evidence | {"requested":0,"confirmed":1} | {"requested":0,"confirmed":1} | true |
| lifecycle-confirmed-rejected | pre-dispatch stops | 0 | 0 | true |
| lifecycle-confirmed-rejected | stream evidence | {"chunks":[],"firstChunkObserved":true} | {"chunks":[],"firstChunkObserved":true} | true |
| lifecycle-confirmed-rejected | busy requests avoid database | 0 | 0 | true |
| lifecycle-confirmed-rejected | saved debits are not refunded | true | true | true |
| lifecycle-confirmed-rejected | complete lifecycle evidence | true | true | true |
