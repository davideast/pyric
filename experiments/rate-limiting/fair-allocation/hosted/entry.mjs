...
import { createHostedFairAllocationApp } from './http-app.mjs';
import { mountObservabilityPreflight } from '../../inference-allowance/services/observability-preflight.mjs';

const project  = process.env.GOOGLE_CLOUD_PROJECT;
const database = process.env.FAIR_DATABASE;
const runId    = process.env.FAIR_RUN_ID;
...
const service = createHostedFairAllocationApp({ db, record, runId, instanceId, environment });
