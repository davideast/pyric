...
const workload   = await compareSources(
    ...
    ['experiments/rate-limiting/automatic-recovery/hosted/workload.mjs', ...sharedSource],
);
...
const report = {
    schemaVersion:   1,
    comparisonKind:  'paired HTTP automatic-recovery workload (Pyric vs Cloud Run + Firestore)',
...
const out = resolve('experiments/rate-limiting/automatic-recovery/hosted/analyses', randomUUID());
