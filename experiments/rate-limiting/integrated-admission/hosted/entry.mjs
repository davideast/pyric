...
import { createHostedIntegratedApp } from './http-app.mjs';
import { mountObservabilityPreflight } from '../../inference-allowance/services/observability-preflight.mjs';

const project  = process.env.GOOGLE_CLOUD_PROJECT;
const database = process.env.INTEGRATED_DATABASE;
const runId    = process.env.INTEGRATED_RUN_ID;
...
const service = createHostedIntegratedApp({ db, record, runId, instanceId, environment });
