...
- [`pyric-admin/firestore` reference](../../firestore/reference/api.md) for the first service that consumes these handles.
- [`pyric-admin/auth` reference](../../auth/reference/api.md) for the three-arm dispatch pattern in full.
