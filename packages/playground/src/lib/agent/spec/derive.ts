/**
 * Pure derivers over AppSpecV1 (plans/app-spec.md section 4) — the closed
 ...
 * (`WorkspaceTestFile[]` — section 5: no parallel types). Enumeration policy,
...
// ─────────────────────────────────────────────────────────────────────
// deriveIdentities — IdentitySpec → SeedUser (typed mapper, section 5)
// ─────────────────────────────────────────────────────────────────────
 ...
 *  test deriver, instead of duplicating the rule (section 5 type-cohesion: one
