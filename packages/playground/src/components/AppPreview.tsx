  ...
  const Component = useMemo(() => {
    ...
    const scope = {
      ...
      'firebase/database': {
        ...
        onChildAdded: shared ? sharedWorkerRuntime.rtdbOnChildAdded : rtdbOnChildAdded,
        onChildChanged: shared ? sharedWorkerRuntime.rtdbOnChildChanged : rtdbOnChildChanged,
        onDisconnect: shared ? sharedWorkerRuntime.rtdbOnDisconnect : rtdbOnDisconnect,
        OnDisconnect: shared ? sharedWorkerRuntime.RtdbOnDisconnect : RtdbOnDisconnect,
        goOffline: shared ? sharedWorkerRuntime.rtdbGoOffline : rtdbGoOffline,
        goOnline: shared ? sharedWorkerRuntime.rtdbGoOnline : rtdbGoOnline,
