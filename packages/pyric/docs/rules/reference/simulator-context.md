...
3. Route only the unsupported cases to the Firebase Rules Test API. See [How to test rules against the Firebase Rules Test API](../how-to/test-rules-against-firebase.md).
