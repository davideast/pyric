...
The rules constraint DSL (`atoms`, `policies`, `compose`, `ruleset`) lives on a separate subpath, `pyric/database/constraints`, and is documented in [rules-tooling.md](./rules-tooling.md).
