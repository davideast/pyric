...
- For a hands-on intro that uses `pyric-admin`, see [Your first sandbox session](../tutorials/01-your-first-sandbox-session.md).
- For the rationale behind the two-adapter design, see [Why service adapters live in sibling packages](../explanation/why-adapters-are-siblings.md).
