...
"Tested against Firebase 12.16" is only honest if the result of that testing is inspectable. Pyric publishes three numbers openly, per service and overall, on the [conformance scoreboard](../conformance/SCORES.md) and each COMPAT matrix:
