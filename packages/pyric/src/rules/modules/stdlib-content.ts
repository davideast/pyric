...
`,
  "storage/metadata": `// Storage custom-metadata policies. Custom metadata is a flat string map.
...
`,
  "storage/objects": `// Storage operation identity. Use request.method rather than null checks:
...
`,
  "storage/time": `// Freshness checks over server-owned Storage object timestamps. Boundaries are
...
`,
  "storage/uploads": `// Storage upload request primitives. These inspect declared object metadata;
