...
This means a tool handler is essentially "an orchestrator with an `Outcome` widened by one more layer for agent consumption". See [Tool factories](../reference/tool-factories.md).
