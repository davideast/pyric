...
real Firebase project (guarded). See [bridge](../bridge/README.md).
...
identical behaviour. See [deploy to a preview channel](../deploy/how-to/deploy-to-a-preview-channel.md).
...
See [configure auth providers and domains](../how-to/configure-auth-providers-and-domains.md).
...
See [infer a schema from an existing Firestore](../how-to/discover-a-schema-from-firestore.md).
