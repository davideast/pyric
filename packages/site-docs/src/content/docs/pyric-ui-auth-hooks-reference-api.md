...
section: "@pyric/ui"
order: 24034
description: "Published declarations for @pyric/ui/auth/hooks."
kind: "api"
apiPackage: "@pyric/ui"
...
| Property | Type | Description |
| :------ | :------ | :------ |
| <a id="config"></a> `config` | [`AuthProviderConfigEntry`](#authproviderconfigentry)[] | Every provider this sandbox has an explicit enablement for. Unknown providers (never toggled) are simply absent — `isEnabled` treats an absent entry as disabled, matching the backend default. |
