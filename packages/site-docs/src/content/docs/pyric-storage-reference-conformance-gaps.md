...
- [Storage rules subset](../pyric-storage-reference-rules-subset/) for the supported grammar.
...
- [Compatibility matrix](../pyric-storage-compat/) for the full row-by-row registry.
