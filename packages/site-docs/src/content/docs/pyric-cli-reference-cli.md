...
See [promote sandbox state to a fixture](../pyric-cli-how-to-promote-sandbox-state-to-a-fixture/).
...
tool calls to a connected in-browser sandbox. See [bridge](../pyric-cli-bridge/).
