...
Watch the state you're shaping move through the system in [See what's happening](../see-whats-happening/), or take a captured session to the deploy gate in [Ship to production](../ship-to-production/).
