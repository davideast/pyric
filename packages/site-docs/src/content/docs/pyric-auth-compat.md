...
| Metric | Value |
|---|---|
| SDK surface coverage | 37.6% of the total surface, 37.6% of the intended surface |
| Behavior conformance | 84 of 101 evaluated rows conform (11 diverged-documented, 5 unsupported, 1 unverified) |
| Assurance capabilities | 0 of 2 capabilities supported (1 qualified, 1 unsupported) |
| Live-prod oracle citations | 29 of 101 rows |

Generated by `bun run compat:generate`. Full rollup: [Conformance scores by surface](../pyric-conformance-scores/).

This matrix is the row-by-row contract of what Auth guarantees against the production Firebase surface, generated from the conformance registry.
