...
Read the [Realtime Database](../pyric-database-compat/) and [Storage](../pyric-storage-compat/) matrices for the exact boundary, or put the claim under load yourself: run the app, break a rule, and compare the verdict against production's.
