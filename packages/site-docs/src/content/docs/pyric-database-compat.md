...
| Metric | Value |
|---|---|
| SDK surface coverage | 64.8% of the total surface, 79.5% of the intended surface (modular SDK surface; the agent-tool surface is native) |
| Behavior conformance | 224 of 258 evaluated rows conform (10 diverged-documented, 13 unsupported, 11 unverified) |
| Assurance capabilities | 0 of 5 capabilities supported (1 qualified, 4 unsupported) |
| Live-prod oracle citations | 95 of 258 rows |

Generated by `bun run compat:generate`. Full rollup: [Conformance scores by surface](../pyric-conformance-scores/).

This matrix is the row-by-row contract of what Realtime Database guarantees against the production Firebase surface, generated from the conformance registry.
