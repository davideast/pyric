...
| Metric | Value |
|---|---|
| SDK surface coverage | 44.4% of the total surface, 66.7% of the intended surface |
| Behavior conformance | 85 of 103 evaluated rows conform (6 diverged-documented, 11 unsupported, 1 unverified) |
| Assurance capabilities | 1 of 3 capabilities supported (2 unsupported) |
| Live-prod oracle citations | 12 of 103 rows |

Generated by `bun run compat:generate`. Full rollup: [Conformance scores by surface](../pyric-conformance-scores/).

This matrix is the row-by-row contract of what Storage guarantees against the production Firebase surface, generated from the conformance registry.
