...
| SDK surface coverage | 100% of total surface, 100% of intended surface (client receive plane; the admin send plane has no separate breadth entry) |
| Behavior conformance | 100.0% conform, 56 of 56 rows |
| Live-prod oracle citations | 15 / 56 rows |
