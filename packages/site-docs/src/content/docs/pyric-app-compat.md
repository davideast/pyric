...
<span class="compat-stat-pct">90%</span>
<span class="compat-stat-label">of public runtime exports supported</span>
</p>
<p class="compat-stat-denom">9 of 10 public runtime exports <span aria-hidden="true">·</span> 4 of 6 public type exports</p>
</div>
...
<summary class="compat-line"><span class="compat-dot" data-status="unsupported" role="img" aria-label="Unsupported" title="Unsupported"></span><span class="compat-main"><code class="compat-api">initializeServerApp</code><span class="compat-sub"><span class="compat-behavior">Not implemented; disposition <code>app.server-app</code> owns the reviewed availability and rationale</span></span></span></summary>
<div class="compat-evidence"><div class="compat-probe">disposition:app.server-app</div></div>
</details>
<details class="compat-row" data-status="ok">
...
<div class="compat-list compat-list--plain">
<div class="compat-row">
<div class="compat-line"><span class="compat-main"><code class="compat-api">initializeServerApp</code><span class="compat-sub">Not implemented; disposition <code>app.server-app</code> owns the reviewed availability and rationale</span></span></div>
</div>
</div>
...
|---|---|---|---|---|
| app.server-app | deferred | `initializeServerApp` | Server-app (SSR) initialization: a FirebaseServerApp carries per-request auth/heartbeat state with no decided sandbox mirror pattern yet. Deferred, not out of scope — tracked as an unsupported registry row (registry/app.ts app#15). | registry:app#15 |
