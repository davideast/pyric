...
| Metric | Value |
|---|---|
| SDK surface coverage | 39.1% of the total surface, 90% of the intended surface |
| Behavior conformance | 14 of 15 evaluated rows conform (1 unsupported) |
| Live-prod oracle citations | 14 of 15 rows |

Generated by `bun run compat:generate`. Full rollup: [Conformance scores by surface](../pyric-conformance-scores/).

This matrix is the row-by-row contract of what App guarantees against the production Firebase surface, generated from the conformance registry.
