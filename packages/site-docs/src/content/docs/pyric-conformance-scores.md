...
Public runtime surface, public type surface, and behavior fidelity answer different questions. [How does Pyric know it works like Firebase?](../how-we-know-it-matches-firebase/) explains the evidence and its limits.
