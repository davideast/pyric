...
| Metric | Value |
|---|---|
| SDK surface coverage | 55.5% of the total surface, 63.5% of the intended surface |
| Behavior conformance | 146 of 166 evaluated rows conform (20 diverged-documented) |
| Assurance capabilities | 1 of 6 capabilities supported (5 unsupported) |
| Live-prod oracle citations | 40 of 166 rows |

Generated by `bun run compat:generate`. Full rollup: [Conformance scores by surface](../pyric-conformance-scores/).

This matrix is the row-by-row contract of what Firestore guarantees against the production Firebase surface, generated from the conformance registry.
