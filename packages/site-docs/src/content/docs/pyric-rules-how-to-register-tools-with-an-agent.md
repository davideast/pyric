...
console.log(result.data);    // the full LintResult
```
...
- For the public tool names, parameters, and the result shape, see [Tool factories in the API reference](../pyric-rules-reference-api/#tool-factories).
