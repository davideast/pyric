...
- [TrafficLog](./TrafficLog.md) — the event stream; virtualized flat list,
  or singles + collapsible groups in grouped mode.
- [TrafficDetail](./TrafficDetail.md) — drill-in panel for one event.
- [RuleHeatmap](./RuleHeatmap.md) — per-rule fire / deny rollup.
- [TrafficStats](./TrafficStats.md) — totals + breakdowns.
