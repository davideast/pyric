...
> `optional` **bridge**: `boolean` \| \{ `disableAuditLog?`: `boolean`; `project?`: `string`; \}
...
> `const` **NODE\_BUILTIN\_RE**: `RegExp`
...
> `const` **NODE\_BUILTIN\_SHIMS**: `Record`\<`string`, `string`\>
...
[`PyricSandboxOptions`](#pyricsandboxoptions)
