...
- For each handler's name, args, and `data` shape, see [Tool factories](../reference/tool-factories.md).
- For the registry and dispatch primitives, see the [`@inbrowser/agent` package](../../../agent/README.md).
