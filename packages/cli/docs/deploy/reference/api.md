...
See [`ProjectScope`, `Outcome`, `AdminApiError`](./scope-and-outcome.md).
...
See [Token caching and `memoizeTtl`](../explanation/token-caching.md).
...
Hosting deploy primitives. See [`hosting` namespace](./hosting-namespace.md):
...
Cloud Functions Gen 2 deploy primitives. See [`functions` namespace](./functions-namespace.md):
...
Firestore rules, indexes, and database primitives. See [`firestore` namespace](./firestore-namespace.md):
