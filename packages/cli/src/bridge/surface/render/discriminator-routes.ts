...
export const DISCRIMINATOR_TOOLS: readonly DiscriminatorTool[] = [
  ...
  },
  {
    ...
    description:
      'Control sandbox environment state: reset one or all services, pin or advance or reset the clock, simulate online/offline network connectivity, checkpoint and restore, page the event log, list attached listeners, read activity incidents, or export and load a fixture.',
