 ...
 *
 * Hosted verification is intentionally absent from the sandbox bridge.
 */
export function getRulesToolHandlers(): ToolHandler[] {
  // Includes simulate / lint / resolve_modules / stdlib_list /
  // stdlib_get. The CLI owns hosted verification credential resolution.
  return createFirestoreRulesTools({});
}
