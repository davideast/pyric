 ...
 *
 * Data-plane calls forward to the WS-connected sandbox browser.
 * Rules tools execute locally in-process.
 *
...
export async function startServer(
  ...
  const inProcess: ToolHandler[] = getRulesToolHandlers();
