...
// Instance-id surface (part of the host's public shape: serve-init imports
// getOrCreateInstanceId; tests import the rest).
export { INSTANCE_ID_KEY, randomUuid, getOrCreateInstanceId } from './host/connection.js';
