...
export { setLens, getLens, subscribeLens, switchAuthLens, getAuthLens, onAuthLensChanged, AUTH_LENS_STORAGE_KEY, hydrateLensFromStorage, setOpIssuer } from './client/core.js';
export type {
  ClientDb,
  ClientRtdb,
  RtdbRefHandle,
