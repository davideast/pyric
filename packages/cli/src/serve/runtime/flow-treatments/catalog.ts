/** Built-in treatment metadata; implementations load only when selected. */
export const builtinTreatments = [
  {
    id: "outline",
    group: "Standard",
    name: "Crisp outline",
  ...
  },
  {
    ...
    name: "Thread map",
    description:
      "Curves connect a labeled listener origin to its observed render regions.",
  ...
  },
  {
    ...
    description:
      "A small spatial map shows recently observed render regions.",
...
export type TreatmentId = (typeof builtinTreatments)[number]["id"];
