...
export const switchAuthLens = A.switchAuthLens;
export const getAuthLens = A.getAuthLens;
export const onAuthLensChanged = A.onAuthLensChanged;
...
export const deleteUser = (
  useWorker ? wc.deleteUser : ipAuth.deleteUser
) as typeof ipAuth.deleteUser;
export const updateEmail = (
  useWorker ? wc.updateEmail : ipAuth.updateEmail
) as typeof ipAuth.updateEmail;
export const updatePassword = (
  useWorker ? wc.updatePassword : ipAuth.updatePassword
) as typeof ipAuth.updatePassword;
export const reload = (
  useWorker ? wc.reload : ipAuth.reload
