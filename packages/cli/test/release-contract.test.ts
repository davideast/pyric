...
describe('ratified @pyric/cli release contract', () => {
  ...
  it('pins the ratified ten-tool, 32-operation MCP inventory independently of its implementation', () => {
    expect(contract.mcpTools).toHaveLength(10);
    expect(contract.mcpOps).toHaveLength(32);
