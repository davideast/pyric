...
const KNOWN_UNREGISTERED: Record<string, string> = {
  ...
  sandbox_inspect: 'replaced by pyric://sandbox/status',
  rtdb_simulate_access: 'replaced by verify_security_rules / diagnose_rule_denial',
  rtdb_crawl_structure: 'replaced by query_sandbox_data / pyric://database/tree/{path}',
  firestore_simulate_rules: 'replaced by verify_security_rules',
  firestore_rules_stdlib_list: 'replaced by pyric://stdlib/rules/{module}',
  firestore_rules_stdlib_get: 'replaced by pyric://stdlib/rules/{module}',
  firestore_lint_rules: 'replaced by verify_security_rules',
  firestore_resolve_modules: 'replaced by verify_security_rules',
