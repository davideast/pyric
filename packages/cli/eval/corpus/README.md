...
- 31 Firestore and Database data: write, update, add, delete, query, batch, tree writes, an
  auto-id push with and without a value, a bounded structural crawl, counts and aggregates,
  path discovery, collection-group search, and index extraction with a confirmed write of
