...
export const ASSURANCE_ENGINE_CAPABILITIES: readonly GeneratedAssuranceCapability[] = [
  ...
  },
  {
    ...
    reasons: [
      "storage.binding.resource: snapshot status \"accepted\"; capability probe \"implemented\"; production-verified by 4 captured scenario(s); covered by rules-engine divergence storage-rules#118",
    ],
  },
  {
