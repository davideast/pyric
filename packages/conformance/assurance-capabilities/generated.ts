...
export const ASSURANCE_ENGINE_CAPABILITIES: readonly GeneratedAssuranceCapability[] = [
  ...
  },
  {
    ...
    reasons: [
      ...
      "firestore.semantic.error-absorption-and: snapshot status \"accepted\"; capability probe \"implemented\"; production-verified by conforming oracle-backed rules-engine row firestore-rules#163",
      "firestore.semantic.error-absorption-or: snapshot status \"accepted\"; capability probe \"implemented\"; production-verified by conforming oracle-backed rules-engine row firestore-rules#163",
    ],
  },
  {
  ...
  },
  {
    ...
    reasons: [
      ...
      "rtdb.rule-kind.write: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 15 captured scenario(s)",
      "rtdb.rule-kind.location-wildcard: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 9 captured scenario(s)",
      "rtdb.binding.auth: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 14 captured scenario(s)",
      "rtdb.binding.auth.uid: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 7 captured scenario(s)",
      ...
      "rtdb.binding.path-variable: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 5 captured scenario(s)",
      "rtdb.method.snapshot.val: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 5 captured scenario(s)",
      "rtdb.method.snapshot.child: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 5 captured scenario(s)",
      "rtdb.method.snapshot.exists: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 4 captured scenario(s)",
      ...
      "rtdb.operator.and: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 8 captured scenario(s)",
      "rtdb.operator.or: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 2 captured scenario(s)",
      "rtdb.operator.not: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by 5 captured scenario(s)",
      "rtdb.semantic.read-cascade: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by conforming oracle-backed rules-engine row rtdb-rules#5",
      "rtdb.semantic.write-cascade: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by conforming oracle-backed rules-engine row rtdb-rules#3, rtdb-rules#5",
      "rtdb.semantic.deny-by-default: snapshot status \"unprobed\"; capability probe \"implemented\"; production-verified by conforming oracle-backed rules-engine row rtdb-rules#13",
    ],
  },
  {
    ...
    reasons: [
      "rtdb.semantic.validate-non-cascade: snapshot status \"unprobed\"; capability probe \"unprobeable\"; no production-captured scenario and no conforming oracle-backed row verifies it; covered by rules-engine divergence rtdb-rules#14, rtdb-rules#15",
