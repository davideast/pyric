...
export const ASSURANCE_ENGINE_CAPABILITIES: readonly GeneratedAssuranceCapability[] = [
  ...
  },
  {
    ...
    dependencies: [
      {"kind":"construct","id":"firestore.function.getAfter","verdict":"unsupported","snapshot":"rejected","probe":"implemented","productionVerified":false,"divergedBy":["firestore-rules#164"]},
      {"kind":"construct","id":"firestore.function.existsAfter","verdict":"unsupported","snapshot":"rejected","probe":"implemented","productionVerified":false,"divergedBy":["firestore-rules#164"]},
  ...
  },
  {
    ...
    dependencies: [
      {"kind":"construct","id":"firestore.rule-kind.allow-list","verdict":"supported","snapshot":"accepted","probe":"implemented","productionVerified":true,"divergedBy":[]},
      {"kind":"construct","id":"firestore.binding.request.query","verdict":"unsupported","snapshot":"accepted","probe":"implemented","productionVerified":false,"divergedBy":["firestore-rules#166"]},
      {"kind":"construct","id":"firestore.binding.resource.data","verdict":"supported","snapshot":"accepted","probe":"implemented","productionVerified":true,"divergedBy":[]},
      {"kind":"construct","id":"firestore.operator.eq","verdict":"supported","snapshot":"accepted","probe":"implemented","productionVerified":true,"divergedBy":[]},
      {"kind":"construct","id":"firestore.operator.and","verdict":"supported","snapshot":"accepted","probe":"implemented","productionVerified":true,"divergedBy":[]},
  ...
  },
  {
    ...
    dependencies: [
      ...
      {"kind":"construct","id":"storage.binding.resource","verdict":"unsupported","snapshot":"accepted","probe":"implemented","productionVerified":false,"divergedBy":["storage-rules#118"]},
