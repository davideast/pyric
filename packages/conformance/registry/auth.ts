    ...
    },
    {
      ...
      rows: [
        ...
        },
        {
          ...
          "behavior": "Not implemented. Deprecated upstream: production returns an empty list when email-enumeration protection is on (the default), so mirroring it would mislead callers.",
          "status": "unsupported",
          "evidence": "Deprecated and retracted upstream; intentionally not implemented.",
          "risk": [],
          "riskScore": 0,
          "riskReasons": [],
          "automation": "unsupported",
