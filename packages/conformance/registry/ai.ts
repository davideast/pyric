...
/** Rows default to 'conforms'; witnesses are authored as bare file names under the climb suite. */
const row = defineRows({
  surface: 'ai',
  defaults: { status: 'conforms' as const },
  expandTest: (file) => `${SUITE}/${file}`,
});
...
const initRows: CompatibilityRow[] = [
  row({
    ...
    conformanceTests: ['instances.test.ts'],
  }),
  row({
...
const generateRows: CompatibilityRow[] = [
  row({
    ...
    oracleObservations: ['ai-generate-minimal-envelope'],
    conformanceTests: ['generate-content.test.ts'],
  }),
  row({
  ...
  row({
    ...
    oracleObservations: ['ai-system-instruction-accepted'],
    conformanceTests: ['generate-content.test.ts'],
  }),
  row({
    ...
    oracleObservations: ['ai-structured-output-shape'],
    conformanceTests: ['generate-content.test.ts'],
  ...
  row({
    ...
    oracleObservations: ['ai-thinking-thought-parts'],
    conformanceTests: ['generate-content.test.ts'],
...
const streamRows: CompatibilityRow[] = [
  row({
    ...
    oracleObservations: ['ai-generate-stream-framing'],
    conformanceTests: ['streaming.test.ts'],
  }),
  row({
...
const chatRows: CompatibilityRow[] = [
  row({
    ...
    conformanceTests: ['upstream-ai-probes.test.ts', 'chat-session.test.ts'],
  }),
  row({
    ...
    conformanceTests: ['chat-session.test.ts'],
...
const fncallRows: CompatibilityRow[] = [
  row({
    ...
    oracleObservations: ['ai-function-call-shape'],
    conformanceTests: ['function-calling.test.ts'],
  ...
  row({
    ...
    oracleObservations: ['ai-function-response-round'],
    conformanceTests: ['function-calling.test.ts'],
  }),
  row({
    ...
    oracleObservations: ['ai-error-fncall-missing-thought-signature'],
    conformanceTests: ['function-calling.test.ts'],
...
const countRows: CompatibilityRow[] = [
  row({
    ...
    oracleObservations: ['ai-counttokens-envelope'],
    conformanceTests: ['errors-counttokens.test.ts'],
  }),
  row({
...
const errorRows: CompatibilityRow[] = [
  row({
    ...
    oracleObservations: ['ai-error-unknown-model'],
    conformanceTests: ['errors-counttokens.test.ts'],
    ...ERROR_RISK,
  }),
  row({
    ...
    oracleObservations: ['ai-error-retired-model'],
    conformanceTests: ['errors-counttokens.test.ts'],
    ...ERROR_RISK,
  ...
  row({
    ...
    oracleObservations: ['ai-error-bad-api-key'],
    conformanceTests: ['errors-counttokens.test.ts'],
    ...ERROR_RISK,
  ...
  row({
    ...
    oracleObservations: ['ai-error-empty-contents'],
    conformanceTests: ['errors-counttokens.test.ts'],
    ...ERROR_RISK,
  }),
  row({
    ...
    oracleObservations: ['ai-error-bad-role'],
    conformanceTests: ['errors-counttokens.test.ts'],
    ...ERROR_RISK,
...
const helperRows: CompatibilityRow[] = [
  row({
    ...
    conformanceTests: ['upstream-ai-probes.test.ts', 'helpers-schema.test.ts'],
  }),
  row({
    ...
    conformanceTests: ['helpers-schema.test.ts'],
  }),
  row({
...
const scriptedRows: CompatibilityRow[] = [
  row({
    ...
    oracleObservations: ['ai-generate-minimal-envelope'],
    conformanceTests: ['engines.test.ts'],
    exceptionReason: ENGINE_EXCEPTION,
