 ...
 * `storage-` observations. See `packages/conformance/docs/oracle-project-setup.md` for the one-time
...
export const rig: RigManifestRecord = {
  ...
  requires: {
    ...
    projectFeatures: [
      ...
      'Firestore rules scoped to the pyric_oracle namespace (see packages/conformance/docs/oracle-project-setup.md for the exact rules snippet).',
